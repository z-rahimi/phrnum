...
protected:	
	...
	int				m_maxDistortion;
	//my code:PhrNumLex
	PhrNumLex* 					m_phrnumlex;
	//BWClasses* m_bwclass;
	std::string m_modelType;
	std::string m_modelNmae;
	//end
  ...
  float m_lmbrMapWeight; //! Weight given to the map solution. See Kumar et al 09 for details
	...
	//my code:PhrNumLex
	bool LoadPhrNumLexModel();
	//bool LoadBWClassesModel();
	//
...
public:
  ...
  inline bool GetDisableDiscarding() const
  {
	...
	//my code: PhrNumLex
	const PhrNumLex* GetPhrNumLexModels() const
	{
		return m_phrnumlex;
	}
	/*const BWClasses* GetBWClasstModel() const
	{
		return m_bwclass;
	}*/
