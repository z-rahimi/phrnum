...
// ,m_cPhrase(copy.m_cPhrase)
// ,m_cachedBWCScores(copy.m_cachedBWCScores)
{}
...
// my code
/*void TranslationOption::CacheBWCScores(map< string, Moses::Scores >& m )
{
  m_cachedBWCScores = m;
}*/
void TranslationOption::CacheClassString(string& str)
{
  m_cPhrase = str;
}
